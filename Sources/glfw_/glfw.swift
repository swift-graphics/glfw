...
//    }
    ...
    *  @brief The key or mouse button was released. */
    ...
    enum Error: Int32 {
         ...
         *  will exist.
         */
        case version_unavailable = 0x00010007
...
//typedef void (*GLFWvkproc)(void);
     ...
     *  @ingroup window
     */
    typealias windowPosFun = (Window, _ upperLeftPos: vec2) -> Void
     ...
     *  @ingroup window
     */
    typealias windowSizeFun = (Window, _ size: vec2) -> Void
     ...
     *  @ingroup window
     */
    typealias windowCloseFun = (Window) -> Void
     ...
     *  @ingroup window
     */
    typealias windowRefreshFun = (Window) -> Void
     ...
     *  @ingroup window
     */
    typealias windowFocusFun = (Window, _ focused: Bool) -> Void
     ...
     *  @ingroup window
     */
    typealias WindowIconifyFun = (Window, _ iconified: Bool) -> Void
     ...
     *  @ingroup window
     */
    typealias framebufferSizeFun = (Window, _ newSize: vec2) -> Void
     ...
     *  @ingroup input
     */
    typealias mouseButtonFun = (Window, MouseButton, InputAction, ModModifier) -> Void
     ...
     *  @ingroup input
     */
    typealias cursorPosFun = (Window, _ newPos: dvec2) -> Void
     ...
     *  @ingroup input
     */
    typealias cursorEnterFun = (Window, _ entered: Bool) -> Void
     ...
     *  @ingroup input
     */
    typealias scrollFun = (Window, _ offset: dvec2) -> Void
     ...
     *  @ingroup input
     */
    typealias keyFun = (Window, Key, _ scancode: Int, InputAction, ModModifier) -> Void
     ...
     *  @ingroup input
     */
    typealias charFun = (Window, _ codepoint: UInt) -> Void
     ...
     *  @ingroup input
     */
    typealias charModsFun = (Window, _ codepoint: UInt, ModModifier) -> Void
     ...
     *  @ingroup input
     */
    typealias dropFun = (Window, _ droppedFiles: Int, _ paths: String...) -> Void
     ...
     *  @ingroup monitor
     */
    typealias monitorFun = (Monitor, _ connected: Bool) -> Void
     ...
     */
    struct Vidmode {
        /*! The size, in screen coordinates, of the video mode.     */
        var size: ivec2
    ...
    struct Image {
        ...
        var pixels: UnsafePointer<CUnsignedChar>
    }
